...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            BCZGUI* window = static_cast<PIVXGUI*>(parentWidget());
...
{
    PIVXGUI* gui = static_cast<BCZGUI*>(parentWidget());
...
{
    hide();
    static_cast<BCZGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("BCZ will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BCZ from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
