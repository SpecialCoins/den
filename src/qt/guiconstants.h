...
// Copyright (c) 2015-2018 The BCZ developers
...
/* Bcz GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BCZ"
#define QAPP_ORG_DOMAIN "bcz.org"
#define QAPP_APP_NAME_DEFAULT "BCZ-Qt"
#define QAPP_APP_NAME_TESTNET "BCZ-Qt-testnet"
