...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, BCZGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, BCZGUI *gui, double posX = 3);
