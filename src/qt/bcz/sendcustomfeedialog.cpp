...
#include "qt/bcz/sendcustomfeedialog.h"
#include "qt/bcz/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(BCZGUI* parent, WalletModel* model) :
