...
#include "qt/bcz/settings/settingssignmessagewidgets.h"
#include "qt/bcz/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(BCZGUI* _window, QWidget *parent) :
