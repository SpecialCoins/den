...
#include "qt/bcz/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bcz/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(BCZGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to BCZGUI::handleRestart()
