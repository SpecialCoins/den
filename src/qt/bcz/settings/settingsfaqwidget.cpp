...
#include "qt/bcz/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/bcz/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(BCZGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBCZ,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableBCZ,
    ...
    connect(ui->pushButton_UnspendableBCZ, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBCZ);});
    ...
    if (parent)
        connect(parent, &BCZGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
