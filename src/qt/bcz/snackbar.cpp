...
#include "qt/bcz/forms/ui_snackbar.h"
#include "qt/bcz/qtutils.h"
#include <QTimer>


SnackBar::SnackBar(BCZGUI* _window, QWidget *parent) :
    QDialog(parent),
    ui(new Ui::SnackBar),
    window(_window)
{
    ...
    if (window)
        connect(window, &BCZGUI::windowResizeEvent, this, &SnackBar::windowResizeEvent);
    else {
