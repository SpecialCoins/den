...
#ifndef BCZ_CORE_NEW_GUI_BCZGUI_H
#define BCZ_CORE_NEW_GUI_BCZGUI_H
...
/**
  BCZ GUI main class. This class represents the main window of the BCZ UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class BCZGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit BCZGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~BCZGUI();
...
#endif //BCZ_CORE_NEW_GUI_BCZGUI_H
