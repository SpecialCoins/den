...
public:
    CMainParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // BCZ starting difficulty is 1 / 2^12
        ...
        // validation by-pass
        consensus.nBCZBadBlockTime = 1471401614;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nBCZBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bcz.seed.fuzzbawls.pw", true));     // Primary DNS Seeder from Fuzzbawls
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bcz.seed2.fuzzbawls.pw", true));    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        // validation by-pass
        consensus.nBCZBadBlockTime = 1489001494; // Skip nBit validation of Block 201 per PR #915
        consensus.nBCZBadBlockBits = 0x1e0a20bd; // Skip nBit validation of Block 201 per PR #915
        ...
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bcz-testnet.seed.fuzzbawls.pw", true));
        vSeeds.push_back(CDNSSeedData("fuzzbawls.pw", "bcz-testnet.seed2.fuzzbawls.pw", true));

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bcz addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bcz script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 73);     // starting with 'W'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bcz BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bcz BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bcz BIP44 coin type is '1' (All coin's testnet default)
